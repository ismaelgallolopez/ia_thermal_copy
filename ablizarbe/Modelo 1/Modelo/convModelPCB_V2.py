...
train_scalar_loader = DataLoader(scalar_dataset, batch_size=batch_size, sampler=train_sampler)
test_loader = DataLoader(dataset, batch_size=batch_size, sampler=test_sampler)
test_scalar_loader = DataLoader(scalar_dataset, batch_size=batch_size, sampler=test_sampler)
...
class Net(nn.Module):
    def __init__(self):
        ...
        #MLP
        self.fc1_1 = nn.Linear(2 * 2 * 40 + 32, 192)
        self.fc1_2 = nn.Linear(192,192)
        self.fc1_3 = nn.Linear(192,192)
        self.fc1_4 = nn.Linear(192,80)
...
scheduler = ReduceLROnPlateau(optimizer, mode='min', factor=0.2, patience=25)
...
# %%
#Guardar el modelo
torch.save(model.state_dict(), 'modelos\modelo_potencias_V2.5.pth')
