...
def visualizar_valores_vectores(output, target):
    ...
    plt.savefig('PotMLP.png', dpi=300, bbox_inches='tight')
...
def visualizar_valores_pixeles(output, target):
    ...
    plt.savefig('PotDistribucionMLP.png', dpi=300, bbox_inches='tight')
...
def visualizar_diferencia_pixeles(output, target):
    ...
    fig.colorbar(cax)
    plt.savefig('PotErrorMLP.png', dpi=300, bbox_inches='tight')
    plt.show()
